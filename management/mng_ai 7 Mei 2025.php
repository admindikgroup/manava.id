...
.copy-btn:hover {
    ...
    .chat-bubble {
        ...
        white-space: pre-line; /* Memastikan format teks tetap terjaga */
    }
                                ...
                                <div class="card-body d-flex">
                                    ...
                                    <div class="flex-grow-1 ml-3 d-flex flex-column" style="width: 75%; height: 585px;">
                                        ...
                                        <form id="chat-form" class="mt-3" enctype="multipart/form-data">
                                            ...
                                            <div id="preview-image-container" class="mb-2 d-flex flex-wrap gap-2" style="display: none !important;">
                    ...
                    success: function (response) {
                        ...
                        if (response.success) {
                            response.data.forEach(chat => {
                                ...
                                if (bubbleClass == "user") {
                                    formattedDetail = escapeHtml(formattedDetail).replace(/\n/g, "<br>");
                                } else {
                                    // Jangan escape & atau entitas HTML lainnya
                                ...
                                function processNode(node) {
                                    const allowedTags = ['STRONG', 'B', 'EM', 'I', 'U', 'BR', 'IMG']; // Tambahkan IMG
