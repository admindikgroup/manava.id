...
// Initialize status_enabled
$status_enabled = "";

// Get current date
$currentDate = new DateTime();
$currentYearMonth = $currentDate->format('Ym');
$selectedYearMonth = $dateObj->format('Ym');
...
<div class="card-body padding-print">
    ...
    <div class="d-flex justify-content-between align-items-center"  style="margin-bottom: -15px;  margin-top: -25px;">
        ...
        <h3 class="modal-title ml-auto" style="color: #00395B; text-transform: uppercase;"><b id="labelRAB">MEMO</b> | <b><?php echo $formattedDate; ?></b></h3>      
    </div>
    <hr>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-12" style="margin-bottom: -15px;">
            <div class="row">
                <label class="col-md-5 col-6 col-form-label"  style="font-weight: unset !important;">Date Print</label>
                <label class="col-md-7 col-6 col-form-label"  style="font-weight: unset !important;">: <?php echo date('d-F-Y'); ?></label>
            </div>
        </div>
        ...
        <div class="col-md-4 col-12" style="margin-bottom: -15px;">
            <div class="row">
                <label class="col-md-5 col-6 col-form-label"  style="font-weight: unset !important;">Memo #</label>
                <label class="col-md-7 col-6 col-form-label"  style="font-weight: unset !important;">: <?php echo 'MEMO-'.$formattedDate2; ?></label>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-12" style=" margin-bottom: 20px;"></div>

        <div class="col-md-4 col-12" style=" margin-bottom: 20px;">
            <div class="row">
                <p class="col-12" style="background-color: #00395B; color: #fff; margin-bottom: 0px;"><b>Belum Disetujui / Tidak disetujui:</b><br></p>
            </div>
        </div>
            ...
            <table id="tableIsiRAB" class="table table-bordered table-striped" style="font-size: 12px; margin-bottom: 50px; width: 100%;">
                <thead>
                    <tr style="background-color: #00395B !important; color: #fff; text-transform: uppercase;">
                        ...
                        <th style="width: 12%; background-color: #00395B !important;">Project</th>
                        <th style="width: 15%; background-color: #00395B !important;">Deskripsi</th>
                        <th style="width: 12%; background-color: #00395B !important;">Nama</th>
                        <th style="width: 12%; background-color: #00395B !important;">No. Rekening</th>
                        <th style="width: 5%; background-color: #00395B !important;">Bank</th>
                        <th style="width: 12%; background-color: #00395B !important;">Amount</th>
                        <th class="no-print" style="width: 5%; background-color: #00395B !important;">Status</th>

                        <?php if($_SESSION['priv']==1){?>
                        <th class="no-print" style="width: 25%; background-color: #00395B !important;">Action</th>
                        <?php } ?>
                    </tr>
                </thead>
                <tbody>
                    ...
                    WHERE MONTH(drd.date_rab) = $monthDate AND YEAR(drd.date_rab) = $yearDate AND (status_rab = 2 or status_rab = 4)
                    ...
                    WHERE MONTH(drd.date_rab) = $monthDate AND YEAR(drd.date_rab) = $yearDate AND (status_rab = 2 or status_rab = 4) AND dd.id_dg_division= $id_dg_division";
                    ...
                    // Query untuk memeriksa apakah id_dg_rab_detail ada di tabel dg_client_project_breakdown_rab
                    $query_detail = "SELECT id_dg_rab_detail FROM dg_client_project_breakdown_rab 
                    WHERE id_dg_rab_detail = $id_dg_rab_detail";

                    // Eksekusi query
                    $result_detail = $db2->query($query_detail);

                    // Cek apakah id_dg_rab_detail ditemukan
                    ...
                    AND id_dg_client_project = $id_dg_client_project AND id_dg_client_project != 0 AND (status_rab = 2 or status_rab = 4) AND id_dg_division = $id_dg_division";
                    ...
                    if($status_rab==2){
                        $status_rab_desk = "<b style='color: orange;'>Belum Disetujui</b>";
                    }else if($status_rab==4){
                        $status_rab_desk = "<b style='color: red;'>Tidak Disetujui</b>";
                    }
                    ...
                    <tr>
                        ...
                        <td class="no-print" style="text-align: center; vertical-align: middle"><?php echo $status_rab_desk; ?></td>

                        <?php if($_SESSION['priv']==1){?>
                        <td class="no-print" style="text-align: left; vertical-align: middle">
                            <?php if($test_data!=1){?>
                                <button class="btn btn-danger btn-sm" data-backdrop="static"
                                    data-keyboard="false" <?php echo $status_enabled; ?>
                                    data-c="<?php echo $id_dg_rab_detail; ?>"
                                    data-v="<?php echo $division_name.'-'.$project_name; ?>"
                                    data-toggle="modal" data-target="#modal-cancel-memo">
                            ...
                            <?php if($status_rab==4){?>
                                <button class="btn btn-warning btn-sm" data-backdrop="static"
                                    ...
                                    data-c="<?php echo $id_dg_rab_detail; ?>"
                                    data-v="<?php echo $division_name.'-'.$project_name; ?>"
                                    data-toggle="modal" data-target="#modal-tinjau">
                            ...
                            <?php if($status_rab==2){?>
                                <button class="btn btn-danger btn-sm" data-backdrop="static"
                                    ...
                                    data-c="<?php echo $id_dg_rab_detail; ?>"
                                    data-v="<?php echo $division_name.'-'.$project_name; ?>"
                                    data-toggle="modal" data-target="#modal-tidak-setuju">
                            ...
                            <?php } ?>
                                <button class="btn btn-success btn-sm" data-backdrop="static"
                                    ...
                                    data-c="<?php echo $id_dg_rab_detail; ?>"
                                    data-v="<?php echo $division_name.'-'.$project_name; ?>"
                                    data-toggle="modal" data-target="#modal-setujui">
        ...
        <br class="pc-none">
            <div class="row">
                <p class="col-12" style="background-color: #00395B; color: #fff; margin-bottom: 0px;"><b>Disetujui:</b><br></p>
            </div>
        </div>
        <div class="col-md-8 col-12" style=" margin-bottom: 20px;"></div>

        <div style="overflow-x: auto; width: 100%;">
            <table id="tableIsiRAB" class="table table-bordered table-striped" style="font-size: 12px; margin-bottom: 50px;">
                <thead>
                    <tr style="background-color: #00395B !important; color: #fff; text-transform: uppercase;">
                        <th style="width: 12%; text-align: center; background-color: #00395B !important;">Divisi</th>
                        <th style="width: 12%; background-color: #00395B !important;">Project</th>
                ...
                <tbody>
                    ...
                    INNER JOIN dg_division dd
                    ON drd.id_dg_division = dd.id_dg_division
                    WHERE MONTH(drd.date_rab) = $monthDate AND YEAR(drd.date_rab) = $yearDate AND status_rab = 3
                    ORDER BY dd.id_dg_division ASC, drd.id_dg_client_project DESC, drd.no_rekening ASC, drd.id_dg_rab_detail DESC");
                    while($d_rab = mysqli_fetch_array($result_rab)){
                        $id_dg_rab_detail = $d_rab['id_dg_rab_detail']; 
                        $division_name = $d_rab['division_name']; 
                    ...
                    FROM `dg_rab_detail` drd
                    INNER JOIN dg_division dd ON drd.id_dg_division = dd.id_dg_division
                    WHERE MONTH(drd.date_rab) = $monthDate AND YEAR(drd.date_rab) = $yearDate AND status_rab = 3 AND dd.id_dg_division= $id_dg_division";
                    ...
                    $sql_count_project = "SELECT COUNT(*) AS total_id_dg_client_project FROM dg_rab_detail
                    WHERE MONTH(date_rab) = $monthDate AND YEAR(date_rab) = $yearDate 
                    AND id_dg_client_project = $id_dg_client_project AND id_dg_client_project != 0 AND status_rab = 3 AND  id_dg_division = $id_dg_division";
        ...
        <div class="col-md-5 col-12" style="border: 1px solid #0002;">
            <div class="row">
                <p class="col-12" style="background-color: #00395B; color: #fff; margin-bottom: 0px;"><b>NOTES</b><br></p>
                <p class="col-12">Memo hanya dibuat untuk pengeluaran yang tidak direncanakan.<br>
        ...
        <div class="col-12" style="margin-top: 50px;">
            <div class="row">
                <p class="col-12">If you have any questions about this Memo, please contact:<br>
...
function saveCheckboxStatus(id_dg_rab_detail,isChecked) {
    ...
    $('#modal-cancel-memo').on('show.bs.modal', function (event) {
        ...
        $('#modal-setujui').on('show.bs.modal', function (event) {
            ...
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            var modal = $(this);
            modal.find('.id_dg_rab_detail_s').val(recipient_c);
            document.getElementById("id_dg_rab_detail_s").value = recipient_c;


            document.getElementById("Jenis_warna4").innerHTML = recipient_v;
        })

        $('#modal-tinjau').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var recipient_c = button.data('c');
            ...
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            var modal = $(this);
            modal.find('.id_dg_rab_detail_t').val(recipient_c);
            document.getElementById("id_dg_rab_detail_t").value = recipient_c;


            document.getElementById("Jenis_warna5").innerHTML = recipient_v;
        })

        
        $('#modal-tidak-setuju').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var recipient_c = button.data('c');
            ...
            // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
            var modal = $(this);
            modal.find('.id_dg_rab_detail_ts').val(recipient_c);
            document.getElementById("id_dg_rab_detail_ts").value = recipient_c;


            document.getElementById("Jenis_warna6").innerHTML = recipient_v;
        })
</script>