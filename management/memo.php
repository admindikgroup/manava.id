...
$bulanTahunTerpilih = isset($_GET['month']) ? $_GET['month'] : date('Y-m', strtotime('first day'));
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Add Memo</h4>
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-12" style="padding-right: 20px;">
                                ...
                                <div class="form-group row">
                                    <label for="projectName2" class="col-12 col-form-label">Memo Name</label>
                                    <div class="col-12">
                                ...
                                <div class="form-group row">
                                    <label for="deskripsiProject2" class="col-12 col-form-label">Deskripsi Memo</label>
                                    <div class="col-12">
                        ...
                        <input type="hidden" name="status_rab" value="2">
    ...
    <div class="modal fade" id="modal-cancel-memo">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <p>Apakah anda yakin menghapus Memo ini ?<br>
                        Memo &nbsp; : <b id="Jenis_warna3"></b><br>
                </div>
    ...
    <div class="modal fade" id="modal-setujui">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">PERHATIAN !!!</h4>
                ...
                <div class="modal-body">
                    <p>Apakah anda yakin mensetujui Memo ini ?<br>
                        Memo &nbsp; : <b id="Jenis_warna4"></b><br>
                </div>
                
                    <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
                    <input type="hidden" name="id_dg_rab_detail_s" id="id_dg_rab_detail_s" value="">
                    <input type="hidden" name="id_client" value="<?php echo $id_client; ?>">

                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
                        <button onclick="setujuiMemo()"  class="btn btn-danger">Yes</button>
                    </div>
    ...
    <div class="modal fade" id="modal-tinjau">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">PERHATIAN !!!</h4>
                ...
                <div class="modal-body">
                    <p>Apakah anda yakin meninjau kembali Memo ini ?<br>
                        Memo &nbsp; : <b id="Jenis_warna5"></b><br>
                </div>
                
                    <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
                    <input type="hidden" name="id_dg_rab_detail_t" id="id_dg_rab_detail_t" value="">
                    <input type="hidden" name="id_client" value="<?php echo $id_client; ?>">

                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
                        <button onclick="tinjauMemo()"  class="btn btn-danger">Yes</button>
                    </div>
    ...
    <div class="modal fade" id="modal-tidak-setuju">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">PERHATIAN !!!</h4>
                ...
                <div class="modal-body">
                    <p>Apakah anda yakin tidak mensetujui Memo ini ?<br>
                        Memo &nbsp; : <b id="Jenis_warna6"></b><br>
                </div>
                
                    <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
                    <input type="hidden" name="id_dg_rab_detail_ts" id="id_dg_rab_detail_ts" value="">
                    <input type="hidden" name="id_client" value="<?php echo $id_client; ?>">

                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
                        <button onclick="tidakSetujuMemo()"  class="btn btn-danger">Yes</button>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 no-print">
                                <div class="d-flex justify-content-end" style="margin: 10px;">
                                    <button style="width: 150px; margin-right: 10px;" class="btn btn-info" onclick="printWithTitle('MEMO')">
                                        Print Memo <i class="fas fa-print pl-2"></i>
                                    </button>

                                    <?php if($_SESSION['priv']==1){?>
                                    <button style="width: 180px; margin-right: 10px;" class="btn btn-info" onclick="printWithTitle('INVOICE MEMO')">
                                        Print Inv. Memo<i class="fas fa-print pl-2"></i>
                                    </button>
                                    
                                    <button class="btn btn-warning" name="id_ev" title="Edit this Memo Info"
                                        data-toggle="modal"
                                    ...
                                    <button class="btn btn-success" name="add_rab" title="Add Memo"
                                        data-toggle="modal"
                                        data-target="#modal-add-rab" data-backdrop="static"
                                        data-keyboard="false"
                                        style="width: 150px;">
                                        Add Memo <i class="fas fa-plus"></i>
                                    </button>
                                    <?php } ?>
...
$(document).ready(function() {
    ...
    var newMonth = (currentDate.getMonth()).toString().padStart(2, '0');
...
function editDataHeader() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (!response.includes('Error')) {
                    ...
                    toastr.error('Gagal menghapus Memo!<br>'+response);
                }
                $('#modal-cancel-memo').modal('hide');
            },
            error: function(xhr, status, error) {
                // Tangani kesalahan saat mengirim permintaan AJAX
                console.error('Error:', error);
    ...
    function setujuiMemo() {
        // Ambil nilai dari input text dengan id "linkProject" dan "linkName"
        var id_user = $('#id_user').val();
        var id_dg_rab_detail = $('#id_dg_rab_detail_s').val();
        var id_client = $('#id_client').val();
        

        // Kirim data form ke server menggunakan AJAX
        $.ajax({
            url: 'controller/conn_setujui_memo.php',
            type: 'POST',
            data: { id_dg_rab_detail: id_dg_rab_detail },
            dataType: 'html',
            success: function(response) {
                ...
                if (!response.includes('Error')) {
                    // Lakukan tindakan sesuai dengan penghapusan berhasil
                    toastr.success('Memo berhasil disetujui.');
                } else {
                    // Lakukan tindakan sesuai dengan penghapusan gagal
                    toastr.error('Gagal mentujui Memo!<br>'+response);
                }
    ...
    function tinjauMemo() {
        // Ambil nilai dari input text dengan id "linkProject" dan "linkName"
        var id_user = $('#id_user').val();
        var id_dg_rab_detail = $('#id_dg_rab_detail_t').val();
        var id_client = $('#id_client').val();
        

        // Kirim data form ke server menggunakan AJAX
        $.ajax({
            url: 'controller/conn_tinjau_memo.php',
            type: 'POST',
            data: { id_dg_rab_detail: id_dg_rab_detail },
            dataType: 'html',
            success: function(response) {
                ...
                if (!response.includes('Error')) {
                    // Lakukan tindakan sesuai dengan penghapusan berhasil
                    toastr.success('Memo berhasil ditinjau.');
                } else {
                    // Lakukan tindakan sesuai dengan penghapusan gagal
                    toastr.error('Gagal meninjau Memo!<br>'+response);
                }
                $('#modal-tinjau').modal('hide');
            },
            error: function(xhr, status, error) {
                // Tangani kesalahan saat mengirim permintaan AJAX
                console.error('Error:', error);
    ...
    function tidakSetujuMemo() {
        // Ambil nilai dari input text dengan id "linkProject" dan "linkName"
        var id_user = $('#id_user').val();
        var id_dg_rab_detail = $('#id_dg_rab_detail_ts').val();
        var id_client = $('#id_client').val();
        

        // Kirim data form ke server menggunakan AJAX
        $.ajax({
            url: 'controller/conn_tidakSetuju_memo.php',
            type: 'POST',
            data: { id_dg_rab_detail: id_dg_rab_detail },
            dataType: 'html',
            success: function(response) {
                ...
                if (!response.includes('Error')) {
                    // Lakukan tindakan sesuai dengan penghapusan berhasil
                    toastr.success('Memo berhasil tidak disetuju.');
                } else {
                    // Lakukan tindakan sesuai dengan penghapusan gagal
                    toastr.error('Gagal tidak mensetujui Memo!<br>'+response);
                }
                $('#modal-tidak-setuju').modal('hide');
            },
            error: function(xhr, status, error) {
                // Tangani kesalahan saat mengirim permintaan AJAX
                console.error('Error:', error);
