...
<head>
    ...
    <title>Management Client's Project | DIK Group</title>
                ...
                <form action="controller/conn_edit_client_project.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="padding-left: 20px;">
                            ...
                            <div class="form-group row">
                                <label for="is_active" class="col-sm-12 col-form-label">Project Status</label>
                                <div class="col-sm-12">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 15px;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date_format(date_create($d_head['tanggal_selesai']),"d F Y"); ?></td>
                                                ...
                                                <td style="text-align: center;">
                                                    <button class="btn btn-warning btn-sm" name="id_ev"
                                                        ...
                                                        onclick="loadModalProjectTeam(<?php echo $d_head['id_dg_client_project']; ?>, '<?php echo $d_head['nama_project']; ?>', '<?php echo $id_client; ?>')"
                                                        data-keyboard="false">
                                                        <i class="fas fa-users">
                                                        </i>
                                                    </button>
                                                    <a class="btn btn-success btn-sm" name="id_ev"
                                                        style="margin-right: 15px;" href="client_project_invoice.php?id_client=<?php echo $id_client; ?>&id_dg_project=<?php echo $d_head['id_dg_client_project']; ?>"
                                                    ...
                                                    <button class="btn btn-primary btn-sm" name="id_ev"
                                                        ...
                                                        onclick="loadModalProjectLink(<?php echo $d_head['id_dg_client_project']; ?>, '<?php echo $d_head['nama_project']; ?>', '<?php echo $id_client; ?>')">
                                                        <i class="fas fa-link">
                                                        </i>
                                                    </button>
