                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="display: block !important;">
                        ...
                        <div class="form-group row" style="padding: 20px;">
                            <label for="teamUser" class="col-sm-2 col-form-label">Team Name</label>
                                <div class="col-sm-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this User from the Group?<br>
                        User Name &nbsp; : <b id="user_group_detail_del"></b><br>
                </div>
                <form method="post">
    ...
    <div class="modal fade" id="modal-cancel-group">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this Group?<br>
                        Group Name &nbsp; : <b id="user_group_del"></b><br>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                                ...
                                <div class="col-12" style="padding-left: 20px;">
                                    ...
                                    <div class="form-group row">
                                        <label for="namaGroup_add" class="col-sm-12 col-form-label">Group Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="namaGroup_add" name="namaGroup_add"
                                                placeholder="Type Group Name" value="" required>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="deslripsiGroup_add" class="col-sm-12 col-form-label">Group Description</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="deslripsiGroup_add" name="deslripsiGroup_add"
                                                placeholder="Type Group Description" value="" required>
                                        </div>
                                    </div>  
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                                ...
                                <div class="col-12" style="padding-left: 20px;">
                                    ...
                                    <div class="form-group row">
                                        <label for="namaGroup_edit" class="col-sm-12 col-form-label">Group Name</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        <label for="deskripsiGroup_edit" class="col-sm-12 col-form-label">Group Description</label>
                                        <div class="col-sm-12">
                                ...
                                <div class="row" style="height: 0px;">
                                    ...
                                    <div class="col-6 form-group" style="z-index: 99; height:10px;">
                                        <button class="btn btn-success float-sm-right" data-toggle="modal"
                                            data-target="#modal-add-group" data-backdrop="static" data-keyboard="false"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <button class="btn btn-danger btn-sm"
                                            data-keyboard="false" title="Delete Group User"
                                            data-c="${group.id_dg_user_group}"
