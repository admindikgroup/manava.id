...
$a_dg_article_category =array();
$result_category = mysqli_query($db2,"select * from dg_article_category_m where id_dg_article = $id");
  while($d_category = mysqli_fetch_array($result_category)){
 
    array_push($a_dg_article_category,$d_category['id_dg_article_category']);

  }

$a_dg_article_tags_m =array();
$result_tags = mysqli_query($db2,"select * from dg_article_tags_m where id_dg_article = $id");
  while($d_tags = mysqli_fetch_array($result_tags)){
 
    array_push($a_dg_article_tags_m, $d_tags['id_dg_article_tags']);
...
<div class="modal fade" id="modal-add-category">
  ...
  <div class="wrapper">
    ...
    <form id='frmTarget' action="controller/conn_edit_article.php" method="post" enctype="multipart/form-data">
      <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
                      ...
                      <div class="col-sm-12 select2-green">
                        <select class="select2" multiple="multiple" data-placeholder="Select a Category" id="article_category" name="article_category[]"
                          ...
                          <?php 
                            ...
                            while($d_head = mysqli_fetch_array($result_head)){
                          ?>
                            <option value="<?php echo $d_head['id_dg_article_category']; ?>" <?php if(in_array($d_head['id_dg_article_category'], $a_dg_article_category)){echo "selected";} ?>><?php echo $d_head['nama_category']; ?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                      ...
                      <div class="col-sm-12 select2-purple">
                        <select class="select2" multiple="multiple" data-placeholder="Select a Tags" id="aticle_tags" name="aticle_tags[]"
                          ...
                          <?php 
                            ...
                            while($d_head = mysqli_fetch_array($result_head)){
                          ?>
                            <option value="<?php echo $d_head['id_dg_article_tags']; ?>" <?php if(in_array($d_head['id_dg_article_tags'], $a_dg_article_tags_m)){echo "selected";} ?>><?php echo $d_head['nama_tags']; ?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-12" style="width : 500px;">
                    ...
                    <div class="row form-group" style="padding-right: 60px;">
                      ...
                      <label for="banner_utama" class="col-12"><img id="blah"
                          ...
                          src="img/article/<?php if($banner_utama==""){echo 'b1.jpg'; }else{ echo $banner_utama; } ?>"
                      ...
                      <input type="hidden" class="form-group" id="banner_utama_lama" name="banner_utama_lama"
                        value="<?php if($banner_utama==""){echo 'b1.jpg'; }else{ echo $banner_utama; } ?>">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-outline card-info">
                ...
                <!-- /.card-body -->
                <div class="card-body">
                  <textarea id="summernote" name="summernote"><?php echo $isi_article_pembuka; ?></textarea>
                  
                  <div class="col-sm-12">
                        <label for="quotes" class="col-sm-12 col-form-label">Quotes</label>
                        <div class="col-sm-12">
                          <input type="text" class="form-control" id="quotes" name="quotes"
                            placeholder="Ketikan Quotes-nya" value="<?php echo $quotes; ?>">
                        </div>
                    </div>

                    <div class="col-sm-12">
                        <label for="author_quotes" class="col-sm-12 col-form-label">Quotes Author Name</label>
                        <div class="col-sm-12">
                          <input type="text" class="form-control" id="author_quotes" name="author_quotes"
                            placeholder="Ketikan nama pembuat Quotes" value="<?php echo $author_quotes; ?>">
                        </div>
                    </div>
                ...
                <div class="col-sm-4" style="width : 500px;">
                  ...
                  <div class="row form-group" style="padding-right: 60px;">
                    ...
                    <label for="banner2" class="col-12"><img id="blah2"
                        style="width: 100%; border: 1px solid black; paddingL 10px;"
                        src="img/article/<?php if($banner1==""){echo 'b1.jpg'; }else{ echo $banner1; } ?>"
                        alt="your image" /></label>
                    ...
                    <input type="hidden" class="form-group" id="banner2_lama" name="banner2_lama"
                      value="<?php if($banner1==""){echo 'b1.jpg'; }else{ echo $banner1; } ?>">
                ...
                <div class="col-sm-4" style="width : 500px;">
                  ...
                  <div class="row form-group" style="padding-right: 60px;">
                    ...
                    <label for="banner3" class="col-12"><img id="blah3"
                        style="width: 100%; border: 1px solid black; paddingL 10px;"
                        src="img/article/<?php if($banner2==""){echo 'b1.jpg'; }else{ echo $banner2; } ?>"
                        alt="your image" /></label>
                    ...
                    <input type="hidden" class="form-group" id="banner3_lama" name="banner3_lama"
                      value="<?php if($banner2==""){echo 'b1.jpg'; }else{ echo $banner2; } ?>">
          ...
          <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
          <input type="hidden" name="id_dg_article" value="<?php echo $id; ?>">
          <div class="row">
            <div class="col-md-12">
              <div class="card card-outline card-info">
                <div class="card-header">
                ...
                <!-- /.card-body -->
                <div class="card-body">
                  <textarea id="summernote2" name="summernote2"><?php echo $isi_article; ?></textarea>
                  <div class="row">
