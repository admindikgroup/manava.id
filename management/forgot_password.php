    ...
    <div class="col-12 col-md-4 body-login">
      <div class="login-box">
        <div class="card card-primary" style="background-color: transparent;">
          <div class="card-body">
            <h1 class="login-box-msg" style="color: white; font-size: 25px; font-weight: bold;">Trouble logging in?</h1>
            <p class="login-box-msg" style="color: grey; font-size: 15px; font-weight: bold; margin-bottom: 10px;">Enter your email or username and we'll send you a link to get back into your account.</p>
            <!--Forget Form-->
            <form id="loginForm" action="controller/conn_forgot.php" method="post" style="margin-top: 10px;">
              <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Email or Username" name="identifier" required>
              </div>
              <div class="row">
                <div class="col-12">
                  <button type="submit" class="btn btn-primary btn-block" style="margin-top: 20px;">Send Login Link</button>
                </div>
              </div>
            </form> 
          </div>
