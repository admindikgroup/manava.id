...
if (mysqli_num_rows($check_result) > 0) {
    ...
    $insert_query = "
        INSERT INTO dg_client_project_type (id_dg_client_project_jenis, nama_type, detail_project_tamplate, created_at, created_by)
        VALUES ($id_dg_client_project_jenis, '$typeName', '$detail_project_tamplate', '$tanggal_now', $id_user)
    ";
